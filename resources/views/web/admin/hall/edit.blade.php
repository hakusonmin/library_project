  ...
  <section class="content">
    <section class="my-wrapper">
      <div class="wrapper">
        ...
        <form action="{{ route('admin.halls.update', ['hall' => $hall->id]) }}" method="POST">
          @csrf
          @method('PATCH')
          <div class="form-element-wrapper">
            <div class="form-element-wrapper-title"><label for="name">図書館名</label></div>
            <div class="form-element-wrapper-content"><input type="text" id="name" name="name" value="{{ old('name', $hall->name) }}" required></div>
          </div>
