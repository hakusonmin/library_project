  ...
  <section class="content">
    <section class="my-wrapper">
      <div class="wrapper">
        ...
        <form action="{{ route('admin.floors.store', ['hall' => $hall->id]) }}" method="POST">
          @csrf
          ...
          <button class="back-button" type="button" onclick="location.href='{{ route('admin.floors.index') }}'">戻る</button>
        </form>
      </div>
    </section>
  </section>
